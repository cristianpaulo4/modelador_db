    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            // Logo e Título
            const Icon(Icons.account_tree_rounded, color: Color(0xFF2563EB), size: 28),
            ...
            OutlinedButton.icon(
                  ...
                  : () {
                      if (canvasState.isConnectingMode) {
                        ...
                        if (canvasState.selectedTableId != null) {
                          canvasNotifier.startConnectionMode(canvasState.selectedTableId!);
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Selecione uma tabela de origem primeiro para conectar.'),
              ...
              icon: Icon(
                canvasState.isConnectingMode ? Icons.close_rounded : Icons.alt_route_rounded,
                size: 18,
              ),
              label: Text(canvasState.isConnectingMode ? 'Cancelar Conexão' : 'Conectar Tabelas'),
              style: OutlinedButton.styleFrom(
                foregroundColor: canvasState.isConnectingMode ? Colors.orange : null,
                side: canvasState.isConnectingMode ? const BorderSide(color: Colors.orange, width: 2) : null,
                padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
              ),
            ),
              ...
              onPressed: () {
                showDialog(
                  ...
                  builder: (ctx) => AlertDialog(
                    ...
                    content: const Text('Tem certeza que deseja remover todas as tabelas e conexões?'),
                    actions: [
                      TextButton(
            ...
            IconButton(
              tooltip: isDark ? 'Alternar para Light Mode' : 'Alternar para Dark Mode',
